export const birdsDataEn = [
    ...
    [{
        ...
        },
        {
            ...
            description: 'The word «jackdaw» comes from the Old Slavonic language and is translated as «black». This word is often used to refer to ravens or other black birds. The Latin name of the jackdaw «monedula» is associated with the words coin for the bird is love for shiny and bright things.',
    ...
    [{
        ...
        },
        {
            ...
            description: 'The melody of the oriole is voice is compared to the sound of a flute. It is difficult for a person to see the oriole, as it lives high in the trees. The oriole is not only a very beautiful, but also a useful bird. It destroys poisonous caterpillars that other birds do not eat.',
    ...
    [{
        ...
        },
        {
            ...
            description: 'The male emperor penguin reaches a height of 130 cm, its weight can approach 50 kg. Of all modern penguins, this species is the largest. The penguin is diet consists of fish, squid and krill. Birds hunt in the ocean in large groups.',
